...
export default function Footer() {
  return (
    <footer className="bg-navy-light/20 border-t border-white/5 pt-16 pb-8 mt-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/properties" className="text-gray-400 hover:text-primary transition-colors text-sm">Properties</Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-primary transition-colors text-sm">About Us</Link>
              </li>
              <li>
                <Link href="/investor" className="text-gray-400 hover:text-primary transition-colors text-sm">Investor Relations</Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-primary transition-colors text-sm">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-gray-400 text-sm">Luxury Villas</li>
              <li className="text-gray-400 text-sm">Commercial Land</li>
              <li className="text-gray-400 text-sm">Property Management</li>
              <li className="text-gray-400 text-sm">Investment Consulting</li>
            </ul>
          </div>
