    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            <Link href="/properties" className="px-8 py-4 bg-primary text-navy-light font-bold rounded-full hover:bg-yellow-400 transition-colors shadow-[0_0_20px_rgba(212,175,55,0.4)] flex items-center justify-center gap-2">
              View Properties <ArrowRight className="h-5 w-5" />
            </Link>
            <Link href="/contact" className="px-8 py-4 glass text-white font-bold rounded-full hover:bg-white/10 transition-colors flex items-center justify-center">
              Book a Consultation
            </Link>
          </motion.div>
        </div>
        ...
        >
          <div className="glass rounded-full p-4 flex flex-col md:flex-row gap-4">
            <div className="flex-1 flex items-center bg-white/5 rounded-full px-6 py-3 border border-white/10 focus-within:border-primary/50 transition-colors">
              <MapPin className="text-primary h-5 w-5 mr-3" />
              <input type="text" placeholder="Location (e.g. Colombo)" className="bg-transparent border-none outline-none text-white w-full placeholder:text-gray-400" />
            </div>
            <div className="flex-1 flex items-center bg-white/5 rounded-full px-6 py-3 border border-white/10 focus-within:border-primary/50 transition-colors">
              ...
              <select className="bg-transparent border-none outline-none text-white w-full appearance-none cursor-pointer">
                <option value="" className="bg-navy text-white">Property Type</option>
                <option value="land" className="bg-navy text-white">Land</option>
                <option value="house" className="bg-navy text-white">House</option>
                <option value="apartment" className="bg-navy text-white">Apartment</option>
              </select>
            </div>
            <div className="flex-1 flex items-center bg-white/5 rounded-full px-6 py-3 border border-white/10 focus-within:border-primary/50 transition-colors">
              <span className="text-primary font-bold mr-3">LKR</span>
              <select className="bg-transparent border-none outline-none text-white w-full appearance-none cursor-pointer">
                <option value="" className="bg-navy text-white">Price Range</option>
                <option value="0-50m" className="bg-navy text-white">Under 50M</option>
                <option value="50m-100m" className="bg-navy text-white">50M - 100M</option>
                <option value="100m+" className="bg-navy text-white">100M+</option>
              </select>
            </div>
            <button className="bg-primary text-navy-light p-4 rounded-full hover:bg-yellow-400 transition-colors shrink-0">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <h3 className="text-3xl md:text-5xl font-bold text-white">Featured Properties</h3>
            </div>
            <Link href="/properties" className="hidden md:flex items-center gap-2 text-gray-400 hover:text-primary transition-colors">
            ...
            {featuredProperties.map((property, idx) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-4 border-t border-white/10 pt-4 mt-4 text-sm text-gray-300">
                    {property.bedrooms > 0 && (
      ...
      <section className="py-24 bg-navy-light/30 border-y border-white/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-white">Why Choose Us</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-4">Trust & Transparency</h4>
              <p className="text-gray-400">100% clear deeds, legally vetted properties, and complete transparency in every transaction.</p>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-4">High ROI Potential</h4>
              <p className="text-gray-400">Strategically selected locations in rapid development zones ensuring maximum return on your investment.</p>
            </motion.div>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-4">Premium Experience</h4>
              <p className="text-gray-400">From luxury villas to smart apartments, we deliver world-class infrastructure and modern amenities.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <Link href="/contact" className="inline-block px-10 py-4 bg-primary text-navy-light font-bold rounded-full hover:bg-yellow-400 transition-colors shadow-[0_0_20px_rgba(212,175,55,0.4)]">
